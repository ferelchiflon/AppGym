...
describe("AnalyticsController", () => {
  ...
  describe("Casos límite y datos atípicos", () => {
    ...
    it("_crearFilaTermometro produce la estructura HTML correcta y la clase de estado", () => {
      const el = mountProgressDOM();
      const controller = new AnalyticsController({ el, rutina: makeRutina(), perfil: makePerfil() });
    ...
    it("_crearFilaTermometro usa el color correcto del indicador para sobre_mrv", () => {
      const el = mountProgressDOM();
      const controller = new AnalyticsController({ el, rutina: makeRutina(), perfil: makePerfil() });
