...
export function fechaCorta(iso: any): string {
  if (!iso) return "—";
...
export function zonaAcwr(r: any): string {
...
export function zonaVolumen(l: any): any {
...
export function dryLast(wellness: any[]): any {
